...
def main():
    ...
    if args.cas_file:
        if not os.path.exists(args.cas_file) or args.cas_file.split(".")[-1] != "json": # Should control MIME type 
            raise Exception("Input UIMA CAS JSON file do not exist or is not a json")
